...
namespace demo
{
    public class MaxHeadroomVideoSourceBoxy : IAvatarRenderer
    {
        ...
        private static readonly ILogger logger = SIPSorcery.LogFactory.CreateLogger<MaxHeadroomVideoSourceBoxy>();
...
#pragma warning restore CS0067
        ...
        /// </param>
        public MaxHeadroomVideoSourceBoxy(IVideoEncoder encoder = null)
        {
